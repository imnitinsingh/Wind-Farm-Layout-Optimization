...
if __name__ == "__main__":
    ...
    turb_coords    =  getTurbLoc(r'..\Data set\turbine_loc_test.csv')
    
    # Load the power curve
    power_curve    =  loadPowerCurve('..\Data set\power_curve.csv')
    
    # Pass wind data csv file location to function binWindResourceData.
    # Retrieve probabilities of wind instance occurence.
    wind_inst_freq =  binWindResourceData(r'..\Data set\Wind Data\wind_data_2007.csv')

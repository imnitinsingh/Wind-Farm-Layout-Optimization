...
if __name__ == "__main__":
    ...
    turb_coords   =  getTurbLoc(r'C:\Users\Nitin.N.Singh\Desktop\HACK\Hacker Earth\turbine_loc_test.csv')
    #turb_coords    = agoodsolution5
    ...
    wind_inst_freq =  binWindResourceData(r'C:\Users\Nitin.N.Singh\Desktop\HACK\Final Datasets\Benbecula\Filtered\wind_data_2016.csv')   
